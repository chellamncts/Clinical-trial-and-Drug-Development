...
document.querySelectorAll(".nav-item").forEach(b => b.onclick = () => {
  ...
  // Reload subjects when switching to Schedule Visit tab
...
async function showVisit(){
  ...
  // Load adverse events for this visit
  let aeHtml = "";
  try {
  ...
  } catch(e){ /* AE service may not be available — silently ignore */ }
...
async function loadSubjects(){
  try {
    ...
    // Schedule Visit dropdown — only ENROLLED subjects
    ...
    // Visit History dropdown — all subjects
