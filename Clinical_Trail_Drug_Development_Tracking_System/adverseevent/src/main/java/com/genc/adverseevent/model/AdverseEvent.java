...
public class AdverseEvent {
    ...
    // Set during classify step
    private String seriousness;          // "SERIOUS" | "NOT_SERIOUS"

    private boolean safetyReportSubmitted = false;

    private String meddraCode;           // MedDRA code assigned during classify

    private Long visitId;                // Optional: visit during which this event occurred
