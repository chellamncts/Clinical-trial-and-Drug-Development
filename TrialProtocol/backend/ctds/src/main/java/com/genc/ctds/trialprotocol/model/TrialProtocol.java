...
public class TrialProtocol {
    ...
    // Breaks the bidirectional loop (Protocol -> sites -> protocol -> ...) during JSON
    // serialization; without this, GET /api/sites recurses infinitely. The frontend
    // never needs protocol.sites, so it is safe to ignore here.
    @JsonIgnore
